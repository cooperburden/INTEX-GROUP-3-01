  ...
  useEffect(() => {
    const fetchRecommendations = async () => {
      try {
        ...
        setMovies(data.recommendations.top_genre);
        setGenreName(data.recommendations.top_genre_name);
      } catch (err: unknown) {
        setError(
...
export default CardSliderFirstGenre;
