...
const Privacy = () => {
  ...
  return (
    <>
      ...
      <div style={{ marginTop: `${headerHeight}px`, padding: "20px" }} className="privacy-container">
        <h1 className="privacy-title">Privacy Policy for CineNiche</h1> {/* Centering the title */}
        <p className="privacy-date"><strong>Last updated:</strong> 08 April 2025</p>
        ...
        <p className="privacy-paragraph">The data controller responsible for the processing of your personal data is CineNiche.</p>

        <h2 className="privacy-heading">2. Personal Data We Collect</h2>
        <p className="privacy-paragraph">
        ...
        <h2 className="privacy-heading">4. Lawful Basis for Processing</h2>
        <p className="privacy-paragraph">
        ...
        <h2 className="privacy-heading">5. Sharing Your Personal Data</h2>
        <p className="privacy-paragraph">
        ...
        <h2 className="privacy-heading">8. Security of Your Data</h2>
        <p className="privacy-paragraph">
        ...
        <h2 className="privacy-heading">9. Cookies and Tracking Technologies</h2>
        <p className="privacy-paragraph">
        ...
        <h2 className="privacy-heading">10. International Transfers</h2>
        <p className="privacy-paragraph">
        ...
        <h2 className="privacy-heading">11. Children's Privacy</h2>
        <p className="privacy-paragraph">
        ...
        <h2 className="privacy-heading">12. Changes to This Privacy Policy</h2>
        <p className="privacy-paragraph">
        ...
        <h2 className="privacy-heading">13. Contact Us</h2>
        <p className="privacy-paragraph">
